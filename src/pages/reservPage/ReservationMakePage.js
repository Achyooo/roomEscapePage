...
import ReservationMake from '../../components/reservation/ReservationMake';
...
const ReservationMakePage = (props) => {
    ...
    return (
        <div>
            ...
            <ReservationMake clientPhone={clientPhone}
                             clientPw={clientPw}
